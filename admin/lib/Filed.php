...
class Filed extends DB
{
    public static $filetype = array('文字' => 'varchar( 200)','数字' => 'int(11)',
                                    ...
                                    '文本区域' => 'text', '日期' => 'date');
    public static $filetypedet=array('文字'=>'<input type="text" name="%s" value="%s">',
                                    '数字'=>'<input type="text" name="%s" value="%s">',
                                    '图片'=>'<input type="text" name="%s" value="%s"><input type="file" name="file%s" >',
                                    '文件'=>'<input type="text" name="%s" value="%s"><input type="file" name="file%s" >',
                                    '文本区域'=>'<textarea name="%s">%s</textarea>',
